...
-------------------------------
1. main.py: Please download the [main.py](/src/main/python/main.py)
2. samples.zip: Please build the samples.zip as specified in the [README](https://github.com/rapidsai/spark-examples)
3. Jars: Please download the jars (`cudf-0.8`, `xgboost4j`, `xgboost4j-spark`) [here](https://repo1.maven.org/maven2/ai/rapids/)
4. Dataset: https://rapidsai-data.s3.us-east-2.amazonaws.com/spark/mortgage.zip
...
```
[xgboost4j_spark]$ find . -type f | sort (TODO: update version details)
./data/mortgage/csv/test/mortgage_eval_merged.csv
./data/mortgage/csv/train/mortgage_train_merged.csv
./libs/cudf-0.8-SNAPSHOT-cuda10.jar
./libs/main.py
./libs/samples.zip
./libs/xgboost4j-0.90-SNAPSHOT-cuda10.jar
./libs/xgboost4j-spark-0.90-SNAPSHOT-cuda10.jar
```
...
# additional jars for XGBoost4J example (TODO: update version details)
